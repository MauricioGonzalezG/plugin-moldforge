...
def _derive_sizes(work, props):
    ...
    return types.SimpleNamespace(
        ...
        # Flanges are built as a mating pair before the split. The panel's
        # thickness is per printed wing, independent of the shell wall.
        wing_thickness=2.0 * getattr(props, "wing_thickness", 2.5),
